<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{route('designer.projects')}}" class="btn btn-primary">Back</a>
    </x-slot>
    ...
    <div class="container">
        ...
        <div id="commentForm" style="display: none;">
            <form method="POST" action="{{ route('designer.projects.addnotes',['id'=>$id]) }}" enctype="multipart/form-data" id="AddnoteForm">
            @csrf
                <div class="mt-4">
